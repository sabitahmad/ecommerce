                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="product_name" id="product-title" placeholder="Product Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mb-4">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="number" class="form-control" name="product_price" id="regular-price" placeholder="Regular Price">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="number" class="form-control" name="product_sale_price" id="sale-price" placeholder="Sale Price">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-inner">
                            ...
                            <div class="row g-3">
                                <div class="col-3">
                                    <span class="badge badge-dim bg-primary fs-6">
                                        <span class="">×</span>&nbsp;
                                        Tag
                                    </span>
                                </div>
